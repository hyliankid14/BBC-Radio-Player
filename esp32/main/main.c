...
void app_main(void)
{
    /* Set timezone immediately (UK: GMT/BST) before any time operations */
    /* POSIX format: std offset dst offset,start,end where offset is hours west of UTC */
    /* GMT=0, BST=-1 (1 hour east) */
